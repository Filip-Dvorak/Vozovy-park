...
{
    public partial class admin_create_res : Form
    {
        public admin_create_res()
        {
            InitializeComponent();
            ...
            {
                if(u.Value.isActice == true)
                listBox2.Items.Add(u.Value.username + "; " + u.Value.jmeno + "; " + u.Value.prijmeni);
            }
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string user = listBox2.SelectedItem.ToString();
                string[] _user = user.Split(';');
                string userId = _user[0];
            ...
            if (DateTime.Compare(dateTimePickerTo.Value, dateTimePickerFrom.Value) > 0 || DateTime.Compare(dateTimePickerTo.Value, dateTimePickerFrom.Value) == 0)
            {
            ...
            bool x = true;
                ...
                if (x == true)
                {
                    ...
                    MessageBox.Show("Rezervace byla vytvořena");
                }
                else
                {
        ...
        private void Uživatel_Click(object sender, EventArgs e)
        {
